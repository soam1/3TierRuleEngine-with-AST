...
public class RuleService {
    ...
    public Rule combineRules(Long ruleId1, Long ruleId2, String operator) throws Exception {
        Rule rule1 = ruleRepository.findById(ruleId1).orElseThrow(() -> new Exception("Rule not found: " + ruleId1));
        Rule rule2 = ruleRepository.findById(ruleId2).orElseThrow(() -> new Exception("Rule not found: " + ruleId2));
    ...
    public boolean evaluateRule(Long ruleId, Map<String, Object> userData) throws Exception {
        Rule rule = ruleRepository.findById(ruleId).orElseThrow(() -> new Exception("Rule not found: " + ruleId));
